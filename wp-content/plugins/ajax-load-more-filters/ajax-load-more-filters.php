...
define('ALM_FILTERS_VERSION', '1.6.3');
define('ALM_FILTERS_RELEASE', 'December 28, 2018');
				...
				$output .= '<'.$container_element.' class="alm-filters alm-filters-container'. $filters_color .'" id="alm-filters-'. $options_obj['id'] .'" data-target="'. $options_obj['target'] .'" data-style="'. $options_obj['style'] .'">';
               	...
               	*/
               	$obj['selected_value'] = (isset($f['selected_value'])) ? esc_attr($f['selected_value']) : '';
				      if(has_filter('alm_filters_'. $options_obj['id'] .'_'. $f['key'] .'_selected')){
   				      $obj['selected_value'] = apply_filters('alm_filters_'. $options_obj['id'] .'_'. $f['key'] .'_selected', $obj['selected_value']);
				      }				      
               	...
               	*/
               	$obj['default_value'] = (isset($f['default_value'])) ? esc_attr($f['default_value']) : '';
				      if(has_filter('alm_filters_'. $options_obj['id'] .'_'. $f['key'] .'_default')){
   				      $obj['default_value'] = apply_filters('alm_filters_'. $options_obj['id'] .'_'. $f['key'] .'_default', $obj['default_value']);
				      }				      
