    ...
    function rml_skip_rest_admin_notice() {
        if (current_user_can('install_plugins')) {
        	...
        	echo '<div class=\'notice notice-error\'>
				...
				<a href="' . admin_url('plugin-install.php?s=WordPress+REST+API+(Version+2)&tab=search&type=term') . '">Show in plugin finder</a> or 
				<a href="' . admin_url('plugin-install.php?tab=plugin-information&plugin=rest-api&TB_iframe=true') . '">install plugin directly</a>.
			</div>';
        }
    }
}
